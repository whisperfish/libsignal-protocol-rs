...
#[test]
fn test_keys_calculate_agreement() {
    const ALICE_PRIVATE: &[u8] = &[
        0xc8, 0x06, 0x43, 0x9d, 0xc9, 0xd2, 0xc4, 0x76, 0xff, 0xed, 0x8f, 0x25,
        0x80, 0xc0, 0x88, 0x8d, 0x58, 0xab, 0x40, 0x6b, 0xf7, 0xae, 0x36, 0x98,
        0x87, 0x90, 0x21, 0xb9, 0x6b, 0xb4, 0xbf, 0x59,
    ...
    let agreement = [
        0xc0, 0x21, 0x71, 0xf9, 0x95, 0x13, 0x72, 0xfa, 0x62, 0x7e, 0xa8, 0xcf,
        0x4a, 0xc, 0x30, 0xe0, 0xa3, 0x9d, 0x4c, 0xc8, 0xcf, 0x26, 0xac, 0xca,
        0x24, 0x53, 0x87, 0x69, 0x9a, 0xb, 0x4c, 0x40,
    ];

    assert_eq!(
        expected_public_key
            .calculate_agreement(&alice_private_key)
            .unwrap(),
        agreement
    );
}
